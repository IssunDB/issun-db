...
| 3 | [load_ldbc](load_ldbc.rs)                                     | An example loading a social network graph and running a few graph analytics algorithms (PageRank, connected components, and betweenness centrality), then a variable-length Cypher traversal |
