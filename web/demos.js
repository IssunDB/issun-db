...
ORDER BY year`,
            ...
            },
            {
                ...
                desc: "The same corpus reached by embedding rather than by wording. This build searches by exact distance, so these are the true nearest neighbours rather than approximate ones.",
                cypher: `MATCH (a:Article)
RETURN a.title AS title, a.year AS year
ORDER BY year`,
